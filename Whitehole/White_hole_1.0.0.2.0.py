...
numbers = []
namez = input("Please, enter c or c1 or c2 for compress and for u or u1 or u2 for extract or d1? ")
if namez=="u1":
               ...
               # print(qqwp)
                ...
                while ao<qqwp:
                     ...
                     if tranbd1==qq:
                         ...
                         qw1=ao1
                         ao1=ao1+2
                         bitblockone01w1=q1qweq1s[qw1:ao1]
                     ...
                     if tranbd==qq:
                         if qq>1:
                             eo=ao-30
                             ao=ao-30
                         b2=bitblockone0w2+"00000000000000000000"+bitblockone01w1
                         
                         #print(b2)
                         #os.system("pause")
                         wer=wer+b2
                     else:
                         if qtqweq2[10:30]=="00000000000000000000" and qq<=65535:
                             
                             #print(ao)
                             #print(eo)
                             
                             b3=qtqweq2[0:10]+"0100000000000000000000"
                             #print(b3)
                             #)os.system("pause"
                             wer=wer+b3
                             #print(b3)
                    ...
                    for byte in sda:
                        ...
                        if a == blockw:
                            ...
                            if blockw==4:
                                 ...
                                 if szxx[10:30]=="00000000000000000000" and assa<=65535:
                                    qqw1q="10"
                                    ...
                                    qqqs=szxx[30:32]+szxzzzasaa+szxzzzas+szxx[0:10]
                                   
                                    asaaq=asaaq+qqqs
                                 elif szxx[10:]=="0100000000000000000000" and assa<=65535:

                                     wer=wer+szxx[0:10]+"00000000000000000000"
